...
module.exports = {"ParentLink":{"Property":"risks","Target":{"EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"}},"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"criticality":"#Page:Mitigations_CreateRisks/#Control:criticality/#Value","descr":"#Page:Mitigations_CreateRisks/#Control:descr/#Value","impact":"#Page:Mitigations_CreateRisks/#Control:impact/#Value","prio":"#Page:Mitigations_CreateRisks/#Control:prio/#Value","title":"#Page:Mitigations_CreateRisks/#Control:title/#Value","supplier_BusinessPartner":"#Page:Mitigations_CreateRisks/#Control:supplier_BusinessPartner/#SelectedValue"},"Target":{"EntitySet":"Risks","Service":"/RisksMobile/Services/RiskManagementService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateRelatedEntity"}
...
module.exports = {"CreateLinks":[],"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"criticality":"#Page:Risks_Create/#Control:criticality/#Value","descr":"#Page:Risks_Create/#Control:descr/#Value","impact":"#Page:Risks_Create/#Control:impact/#Value","prio":"#Page:Risks_Create/#Control:prio/#Value","title":"#Page:Risks_Create/#Control:title/#Value","supplier_BusinessPartner":"#Page:Risks_Create/#Control:supplier_BusinessPartner/#SelectedValue"},"Target":{"EntitySet":"Risks","Service":"/RisksMobile/Services/RiskManagementService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}
...
module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Risks","Service":"/RisksMobile/Services/RiskManagementService.service","ReadLink":"{@odata.readLink}"},"Properties":{"criticality":"#Page:Risks_Edit/#Control:criticality/#Value","descr":"#Page:Risks_Edit/#Control:descr/#Value","impact":"#Page:Risks_Edit/#Control:impact/#Value","prio":"#Page:Risks_Edit/#Control:prio/#Value","title":"#Page:Risks_Edit/#Control:title/#Value","supplier_BusinessPartner":"#Page:Risks_Edit/#Control:supplier_BusinessPartner/#SelectedValue"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}
